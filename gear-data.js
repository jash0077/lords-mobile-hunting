const gearData = {
    "helmet": [
        ...
        { id: "h5", name: "Frostwing Mask", level: 55, rarity: "Legendary", image: "https://img.icons8.com/color/96/winter-anorak.png", stats: { combat: { rng_atk: 30, inf_atk: 15 }, economy: { max_energy: 30, training_speed: 8 } } },
        { id: "h6", name: "Gargantua Helm", level: 45, rarity: "Epic", image: "https://img.icons8.com/color/96/iron-mask.png", stats: { combat: { inf_hp: 30, army_def: 25 }, economy: {} } }
    ],
    "armor": [
        ...
        { id: "a5", name: "Regal Platemail", level: 60, rarity: "Mythic", image: "https://img.icons8.com/color/96/armored-pants.png", stats: { combat: { army_atk: 25, army_def: 25, army_hp: 25 }, economy: { construction_speed: 15 } } }
    ],
    "legs": [
    ...
    "accessory": [
        ...
        { id: "ac6", name: "Gargantua Eye", level: 45, rarity: "Epic", image: "https://img.icons8.com/color/96/eye.png", stats: { combat: { inf_def: 25, army_hp: 15 }, economy: {} } }
    ]
};
